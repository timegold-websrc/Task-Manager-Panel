            ...
            <div class="row auth-box-main">
                <div class="col-12">
                    <form class="form-horizontal mt-3" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><img
                                        src="../assets/images/icons/ti-username.png" width="17" style="opacity:.5;" alt=""></span>
                            </div>
                            <input
                                class="form-control form-control-lg form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                type="text" placeholder="Name" id="name" name="name" value="{{ old('name') }}" required
                                autofocus>
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon2"><img width="17" style="opacity:.5;"
                                        src="../assets/images/icons/ti-cpassword.png" alt=""></span>
                            </div>
        ...
        <div class="row mt-2">
            <div class="col-sm-12">
                <a href="{{ route('password.request') }}" id="" class="text-white float-left offset-1-1"> Forgot
                    password?</a>
                <a href="{{ route('login') }}" id="" class="text-white float-right"> Sign In</a>
            </div>
        </div>
        <div id="recoverform">
            <div class="logo">
